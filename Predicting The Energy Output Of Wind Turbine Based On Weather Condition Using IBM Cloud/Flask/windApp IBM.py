...
API_KEY = "_0bAP7n5nfo6p1FhEr0GOmV2_E1okNi9Fep9KYKXU7dR"
...
def y_predict():
    ...
    response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/f5340717-824d-4aa2-b3ba-07f9b57460d8/predictions?version=2022-01-21', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
